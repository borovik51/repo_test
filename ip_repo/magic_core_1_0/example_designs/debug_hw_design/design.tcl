...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: magic_core_0, and set properties
	set magic_core_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:magic_core:1.0 magic_core_0 ]
	...
	# Connect all clock & reset of magic_core_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins magic_core_0/s_magci_core]
	connect_bd_net [get_bd_pins magic_core_0/s_magci_core_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins magic_core_0/s_magci_core_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to magic_core_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/magic_core_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_magic_core_0_s_magci_core_* ]]
	puts $fp "set s_magci_core_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:magic_core:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/magic_core_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "magic_core_v1_0_hw_${i}"
