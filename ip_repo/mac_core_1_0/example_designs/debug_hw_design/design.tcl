...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of mac_core_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins mac_core_0/s_mac_core]
	connect_bd_net [get_bd_pins mac_core_0/s_mac_core_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mac_core_0/s_mac_core_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to mac_core_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/mac_core_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mac_core_0_s_mac_core_* ]]
	puts $fp "set s_mac_core_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/mac_core_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "mac_core_v1_0_hw_${i}"
