...
REM
REM Generated by Vivado on Fri Jun 14 11:27:49 +0300 2024
...
echo "xvhdl --incr --relax -prj generator_tb_vhdl.prj"
call xvhdl  --incr --relax -prj generator_tb_vhdl.prj -log xvhdl.log
